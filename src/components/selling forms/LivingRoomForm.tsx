...
import './LivingRoomForm.css'; // Ensure you have your CSS for styling
...
const LivingRoomForm = () => {
    const [formData, setFormData] = useState({
        ...
        adTitle: '',
        description: '',
        category: 'Furniture / Living Room', // Add category for Living Room
    ...
    const handleFileUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        setFormData({
            ...formData,
            photos: files // Handle living room furniture photos
        });
    ...
    const resetForm = () => {
        setFormData({
            ...
            adTitle: '',
            description: '',
            category: 'Furniture / Living Room', // Reset category field
    ...
    const handleConfirm = async () => {
        ...
        try {
            const docRef = await addDoc(collection(db, 'living_room_furniture'), {
            ...
            resetForm();
            setIsReview(false);
            alert('Living room furniture details submitted successfully!');
        } catch (error) {
            console.error('Error adding document: ', error);
            alert('Error submitting the living room furniture details. Please try again.');
        } finally {
    ...
    return (
        <div className="living-room-form-container">
            {/* Header Section */}
            <header className="form-header">
                <h2>POST YOUR LIVING ROOM FURNITURE AD</h2>
                <div className="category-selector">
                    <span>Selected Category: Furniture / Living Room</span>
                </div>
            </header>

            {!isReview ? (
                <form onSubmit={handleSubmit} className="living-room-form">
