...
import './AccessoriesForm.css'; // Ensure you have your CSS for styling
...
const AccessoriesForm = () => {
    const [formData, setFormData] = useState({
        ...
        userName: '',
        phoneNumber: '',
        category: 'Fashion / Accessories' // Add category here
    });
    ...
    const handleFileUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        setFormData({
            ...formData,
            photos: files // Handle accessory photos
        });
    ...
    const resetForm = () => {
        setFormData({
            ...
            userName: '',
            phoneNumber: '',
            category: 'Fashion / Accessories' // Reset category
        });
    ...
    const handleConfirm = async () => {
        ...
        try {
            ...
            resetForm();
            setIsReview(false);
            alert('Accessory details submitted successfully!');
        } catch (error) {
            console.error('Error adding document: ', error);
            alert('Error submitting the accessory details. Please try again.');
        } finally {
    ...
    return (
        <div className="accessories-form-container">
            {/* Header Section */}
            <header className="form-header">
                <h2>POST YOUR ACCESSORY AD</h2>
            ...
            {!isReview ? (
                <form onSubmit={handleSubmit} className="accessories-form">
                    ...
                    <section className="form-section">
                        ...
                        <div className="form-group">
                            ...
                            <input type="text" id="type" name="type" value={formData.type} onChange={handleInputChange} required />
                        </div>
                ...
                <section className="review-section">
                    ...
                    <div className="review-details">
                        ...
                        <p><strong>Category:</strong> {formData.category}</p> {/* Display the category */}
