...
const PropertyForm = () => {
    ...
    // Function to handle confirmation and submit data to Firestore
    const handleConfirm = async () => {
        setIsSubmitting(true); // Start submission
        try {
            // Add to Firebase (properties collection)
            const docRef = await addDoc(collection(db, 'properties'), {
                ...
                category: 'Property / For Sale: Office', // Explicitly set category
                image: imagePreview || '/placeholder.jpg', // Convert photos to URLs
            });
        ...
        <div className="property-form-container">
            ...
            <header className="form-header">
                ...
                <div className="category-selector">
                    <span>Selected Category: Properties / For Sale: Office</span>
                </div>
            </header>
                    ...
                    <section className="form-section">
                        ...
                        {imagePreview && (
                            <div className="image-preview">
                                <img src={imagePreview} alt="Image Preview" className="w-60 h-48 object-cover" />
                            </div>
                        )}
                    </section>
