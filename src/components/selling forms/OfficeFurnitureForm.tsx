...
const OfficeFurnitureForm = () => {
    const [formData, setFormData] = useState({
        ...
        adTitle: '',
        description: '',
        category: 'Furniture / Office', // Add category for Office Furniture
    ...
    const handleFileUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        setFormData({
            ...formData,
            photos: files // Handle office furniture photos
        });
    ...
    const resetForm = () => {
        setFormData({
            ...
            adTitle: '',
            description: '',
            category: 'Furniture / Office', // Reset category field
    ...
    const handleConfirm = async () => {
        ...
        try {
            const docRef = await addDoc(collection(db, 'office_furniture'), {
            ...
            resetForm();
            setIsReview(false);
            alert('Office furniture details submitted successfully!');
        } catch (error) {
            console.error('Error adding document: ', error);
            alert('Error submitting the office furniture details. Please try again.');
        } finally {
    ...
    return (
        <div className="office-furniture-form-container">
            {/* Header Section */}
            <header className="form-header">
                <h2>POST YOUR OFFICE FURNITURE AD</h2>
                <div className="category-selector">
                    <span>Selected Category: Furniture / Office</span>
                </div>
            </header>

            {!isReview ? (
                <form onSubmit={handleSubmit} className="office-furniture-form">
...
export default OfficeFurnitureForm;
