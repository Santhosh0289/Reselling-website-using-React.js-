...
import './ClothingForm.css'; // Ensure you have your CSS for styling
...
const ClothingForm = () => {
    const [formData, setFormData] = useState({
        ...
        userName: '',
        phoneNumber: '',
        category: 'Fashion / Clothing' // Add category here
    });
    ...
    const handleFileUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        setFormData({
            ...formData,
            photos: files // Handle clothing photos
        });
    ...
    const resetForm = () => {
        setFormData({
            ...
            userName: '',
            phoneNumber: '',
            category: 'Fashion / Clothing' // Reset category
        });
    ...
    const handleConfirm = async () => {
        ...
        try {
            ...
            resetForm();
            setIsReview(false);
            alert('Clothing details submitted successfully!');
        } catch (error) {
            console.error('Error adding document: ', error);
            alert('Error submitting the clothing details. Please try again.');
        } finally {
