...
const SportsEquipmentForm = () => {
    const [formData, setFormData] = useState({
        ...
        userName: '',
        phoneNumber: '',
        category: 'Books, Sports & Hobbies / Sports Equipment' // Category for sports equipment
    });
    ...
    const handleFileUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        setFormData({
            ...formData,
            photos: files // Handle sports equipment photos
        });
    ...
    const resetForm = () => {
        setFormData({
            ...
            userName: '',
            phoneNumber: '',
            category: 'Books, Sports & Hobbies / Sports Equipment' // Reset category
        });
    ...
    const handleConfirm = async () => {
        ...
        try {
            const docRef = await addDoc(collection(db, 'sports_equipment'), {
            ...
            resetForm();
            setIsReview(false);
            alert('Sports equipment details submitted successfully!');
        } catch (error) {
            console.error('Error adding document: ', error);
            alert('Error submitting the sports equipment details. Please try again.');
        } finally {
    ...
    return (
        <div className="sports-equipment-form-container">
            {/* Header Section */}
            <header className="form-header">
                <h2>POST YOUR SPORTS EQUIPMENT AD</h2>
                <div className="category-selector">
                    <span>Selected Category: Books, Sports & Hobbies / Sports Equipment</span>
                </div>
            </header>

            {!isReview ? (
                <form onSubmit={handleSubmit} className="sports-equipment-form">
                    {/* Sports Equipment Details Section */}
                    <section className="form-section">
                        ...
                        <div className="form-group">
                            ...
                            <input type="text" id="equipmentName" name="equipmentName" value={formData.equipmentName} onChange={handleInputChange} required />
                        </div>
                ...
                <section className="review-section">
                    ...
                    <div className="review-details">
                        <p><strong>Equipment Name:</strong> {formData.equipmentName}</p>
...
export default SportsEquipmentForm;
