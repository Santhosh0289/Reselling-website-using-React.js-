...
import './CatsForm.css'; // Ensure you have your CSS for styling
...
const CatsForm = () => {
    const [formData, setFormData] = useState({
        ...
        category: 'Pets / Cats', // Static category for Cats
    });
    ...
    const handleFileUpload = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        setFormData({
            ...formData,
            photos: files // Handle cat photos
        });
    ...
    const resetForm = () => {
        setFormData({
            ...
            category: 'Pets / Cats', // Reset category
        });
    ...
    const handleConfirm = async () => {
        ...
        try {
            ...
            alert('Error submitting the cat details. Please try again.');
        } finally {
    ...
    return (
        <div className="cats-form-container">
            {/* Header Section */}
            <header className="form-header">
                <h2>POST YOUR CAT AD</h2>
            ...
            {!isReview ? (
                <form onSubmit={handleSubmit} className="cats-form">
                    ...
                    <section className="form-section">
                        ...
                        <div className="form-group">
                            ...
                            <input type="text" id="catName" name="catName" value={formData.catName} onChange={handleInputChange} required />
                        </div>
                ...
                <section className="review-section">
                    ...
                    <div className="review-details">
                        <p><strong>Cat Name:</strong> {formData.catName}</p>
